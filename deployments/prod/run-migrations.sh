...
# Judging DB
echo "→ Migrating hackathon_judging..."
GOOSE_DRIVER=postgres \
GOOSE_DBSTRING="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:5432/hackathon_judging?sslmode=disable" \
goose -dir /migrations/judging up
