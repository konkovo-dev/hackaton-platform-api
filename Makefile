...
SERVICES := identity-service hackaton-service team-service submission-service participation-and-roles-service mentors-service matchmaking-service judging-service auth-service
